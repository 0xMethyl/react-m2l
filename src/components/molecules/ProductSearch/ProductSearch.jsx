...
const ProductSearch = () => {
    ...
    const fetchProduits = () => {
        ...
        axios.get("http://localhost:4000/produits/search/" + searchParams.get("keyword"))
            .then((res) => {
                console.log(res);
    ...
    return(
        <div className="container produit-list" >
                <div className="row" >
                    <h3 style={{marginLeft:"1%", fontFamily: "sans-serif"}}>Produits associés à la recherche : {searchParams.get("keyword")}</h3>
